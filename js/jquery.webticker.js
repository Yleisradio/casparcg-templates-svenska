...
(function( $ ){
	...
	function moveFirstElement($strip){
        ...
        var $first = $strip.children().first();
        // Code added by Nicke
        var textData = $first.prop('outerHTML');
        textOffScreen = textData.substring(textData.indexOf('px;">') + 5, textData.indexOf('</li>'));
        // add stops
  ...
  var methods = {
	...
	// function added by Nicke
    itemPlayed : function(){
      return textOffScreen;
    }
  };
